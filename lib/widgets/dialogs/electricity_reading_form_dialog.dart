...
class ElectricityReadingFormDialog extends StatefulWidget {
  ...
  const ElectricityReadingFormDialog({super.key, this.reading});
  ...
  static Future<ElectricityReadingFormData?> show(
    ...
    return showDialog<ElectricityReadingFormData>(
      context: context,
      builder: (context) => ElectricityReadingFormDialog(reading: reading),
    );
  }
...
class _ElectricityReadingFormDialogState
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: Text(isEditing ? l10n.editElectricityReading : l10n.addElectricityReading),
      content: Form(
        key: _formKey,
        child: Column(
  ...
  void _onSave() {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      Navigator.of(context).pop(ElectricityReadingFormData(
